...
def summation_using_accumulate(n, term):
    ...
    """
    "*** YOUR CODE HERE ***"
    return accumulate(add, 0, n, identity)
...
def funception(func1, start):
    ...
    """
    "*** YOUR CODE HERE ***"
    return lambda n:(reduce(mul, map(func1,range(start,n)), 1) if start < n else func1(start)) if start>=0 else None
...
def mod_maker():
    ...
    True
    """
    return lambda a,b:a%b if a%b!=0 else True
